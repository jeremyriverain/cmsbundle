...
function createModal(message) {
  ...
  var askForConfirmation = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;

  var uniqid = id || new Date().getTime().toString(16);
  var actions = void 0;
...
var initCollection = function initCollection(options) {
...
var callbackAfterAdd = function callbackAfterAdd() {
...
var handlePositionButtons = function handlePositionButtons() {
...
var upAction = function upAction(item) {
  var prev = $(item).prev(elementClass);
...
var downAction = function downAction(item) {
  var next = $(item).next(elementClass);
  ...
  if (Boolean($(collectionContainer).data('collection-sf')) === true) {
    ...
    $.each(items, function (index, value) {
      $.each($(value).find('select, input'), function (i, v) {
        var str = $(v).attr('name');
        if (str !== undefined) {
          var newstr = str.replace(re, '[' + index + ']');
          $(v).attr('name', newstr);
        }
      });
    });
    ...
    var data = [];
    $.each(items, function (index, value) {
      var exPosition = Number($(value).attr('data-collection-position'));
...
var handleAddButton = function handleAddButton() {
  var addButton = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
...
var addForm = function addForm(addButton) {
  formPrototype = $(addButton).closest('.collection-container').data('prototype');
  var newForm = formPrototype.replace(/__name__/g, '' + length);
  var hasElementClass = newForm.search('item-collection') === -1 ? false : true;
  if (!hasElementClass) {
...
var handleRemoval = function handleRemoval(elementContainer) {
  elementContainer.remove();
};

var handleRemoveButtons = function handleRemoveButtons(collectionContainer) {
...
var addRemoveButton = function addRemoveButton(item) {
  var wrapper = void 0,
      removeButton = void 0;
  wrapper = $("<p class=''></p>");
...
$(document).ready(function () {
    ...
    $('input.color-picker').each(function (index, value) {
        $(value).spectrum({
            allowEmpty: true,
            preferredFormat: "hex",
            //showButtons: false,
...
/* WEBPACK VAR INJECTION */(function(jQuery, $) {// Check for jQuery.
...
/* WEBPACK VAR INJECTION */(function(jQuery) {// Custom Easing
...
/* WEBPACK VAR INJECTION */(function(jQuery, __webpack_provided_window_dot_jQuery) {var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_RESULT__;/*! VelocityJS.org (1.2.3). (C) 2014 Julian Shapiro. MIT @license: en.wikipedia.org/wiki/MIT_License */
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(17)(module), __webpack_require__(0), __webpack_require__(0)))
...
/* WEBPACK VAR INJECTION */(function(jQuery) {(function($, Vel) {
  'use strict';
...
$(document).ready(function () {
    $(document).on('click', 'input[type=checkbox].switch-action', function (e) {
        ...
        var namespaceParent = input.attr('data-namespaceParent');
...
var $delete = function $delete(url, id, namespace) {
  $.ajax({
    url: url,
    method: "DELETE",
    data: {
    ...
    success: function success(response) {
      if (response.success === true) {
        ...
        (0, _modal.createModal)('<p>' + failMsg + '</p>');
        console.log(response);
      }
    }
  });
...
(function () {
  $(document).on('click', 'a.delete-action', function (e) {
    ...
    (0, _modal.createModal)("<p>Êtes-vous sûr de vouloir supprimer ?</p>", id, true);
    ...
    $('#' + id).on('click', '.modal-action.confirm', function () {
      ...
      var namespace = $(item).attr('data-namespace');
      ...
      if ($('form#form-update-module').length) {
        $(this).replaceWith('<div>' + (0, _loader2.default)() + '</div>');
...
(function () {
      ...
      $.ajax({
        ...
        success: function success(response) {
          if (response.success === true) {
            ...
            var containerError = $('<div class="red-text text-darken-1 errors mb-1"></div>');
  ...
  if ($(".module-adder").length) {
    $(".module-adder").on('click', '.module-item', function () {
      ...
      var container = $(this).closest('.module-adder');
      var divLoader = '<div class="d-f jc-c">' + (0, _loader2.default)() + '</div>';
      ...
      $.ajax({
        ...
        success: function success(response) {
          if (response.success === true) {
            ...
            (0, _modal.createModal)('<p>' + response.message + '</p>');
          }
        }
      });
    });
...
(function () {
    if ($('#property-updatable').length) {
        var container = $("#property-updatable");
        container.on('change', 'input.updatable-item', function (ev) {
            ...
            var namespace = input.data('namespace');
...
(function () {
  ...
  var modifyPosition = function modifyPosition() {
    $.each(childrenContainers, function (index, value) {
      var inputs = $(value).find('[name]');
      $.each(inputs, function (nest_index, nest_value) {
        var currentName = $(nest_value).attr('name');
